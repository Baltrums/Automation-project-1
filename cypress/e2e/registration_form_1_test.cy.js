...
describe('This is first test suite,Ingus Baltrums',  () => {
    it('User can submit data only when valid mandatory values are added', () => {
        /*26.04.24*/
        cy.get('[data-testid="phoneNumberTestId"]').type('2223331111')
        cy.get('#firstName').type('Ingus')
